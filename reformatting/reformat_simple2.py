...
def format_outputs(outputs):
    ...
    if "instruction" in outputs and outputs["instruction"] is not None:
        out += f"<h>{outputs['instruction']}</span>\n"
