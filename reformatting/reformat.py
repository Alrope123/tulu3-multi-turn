...
break_prompt = "Break the following text enclosed by <div> into an optional task instruction and a list of conversations, each composed by a query and a response, except the last conversation only contains a query. Enclose the task instruction with <span> if it exists, enclose each conversation with <section>. Within each conversation, enclose the query with <h> and enclose the response with <p>"
...
DEMOS = [
    {
        ...
        "outputs": {
            ...
            "examples": [
                {
                    "query": "Generate a context and a hypothesis.\n\nAnswer:",
                    "response": " Context: Increased liabilities will add a little to the cost of marine insurance but commercial vessels insured in mutual protection and indemnity associations will probably see no substantive increase in insurance rates because coverage already provided by mutual associations is unlimited.\n\nHypothesis: Increased liabilities will up the cost of marine insurance a little.\n\n\n" 
                },
                {
                    "query": "Generate a context and a hypothesis.\n\nAnswer:",
                    "response": " Context: The Bird's Nest<br>The couple planted a tree in their backyard. A bird immediately moved in. He made an intricate nest. Soon, there were a few eggs! The bird took care of the eggs until they hatched.\n\nHypothesis: the bird is female\n\n\n"
                },
                {
                    "query": "Generate a context and a hypothesis.\n\nAnswer:",
                    "response": " Context: Safety<br>Anna and her boyfriend were fooling around. Then Anna saw that they were out of condoms. Her boyfriend told her it didn't matter, but Anna remained steadfast. Later, she thought the incident over. She was proud of herself for doing the right thing.\n\nHypothesis: : Anna like he boyfiend thought it didn't matter that they were out of condoms\n\n\n" 
                },
                {
                    "query": "Generate a context and a hypothesis.\n\nAnswer:"
                }
    ...
    },
    {
        ...
        "outputs": {
            ...
            "examples": [
                {
                    "query": "Palestinians seek to visit Arafat\n\nTop Palestinian officials are to meet the French president in the hope of visiting the ailing Yasser Arafat.\nWhich topic is this article about?\nOPTIONS:\n- World\n- Sports\n- Business\n- Science/Tech\n\n",
                    "response": "World\n\n\n" 
                },
                {
                    "query": "question: Artest suspended for rest of season\n\nThe NBA has suspended Indiana Pacers forward Ron Artest for the remainder of the season for his part in a brawl during the final minute of Friday #39;s win at Detroit.\n\nOPTIONS:\n- World\n- Sports\n- Business\n- Science/Tech\n",
                    "response": "answer: Sports\n\n\n"
                },
                {
                    "query": "question: Online travel store Lastminute.com LMC.L says earnings for its crucial summer quarter will come in towards the lower end of expectations, sending its stock down 5 percent in early trade.\nQ: Which is the best summary of this article?\nOPTIONS:\n- World\n- Sports\n- Business\n- Science/Tech\nI think the answer is\n",
                    "response": "answer: Business\n\n\n" 
                },
                {
                    "query": "IN: Five people were dead and four still missing on Sunday as Japan began a clean up after the most powerful typhoon in a decade hit the Tokyo region.\n\nOPTIONS:\n- World\n- Sports\n- Business\n- Science/Tech\n\n",
                    "response": "OUT: World\n\n\n"
                },
                {
                    "query": "The Open Source Development Labs (OSDL), a global consortium dedicated to accelerating the adoption of Linux in the enterprise, today announced the creation of a Open Source Software Licensing amp; Legal education track at its upcoming Enterprise Linux \n\nOPTIONS:\n- World\n- Sports\n- Business\n- Science/Tech\n\n",
                    "response": "Correct title: Science/Tech\n\n\n"
                },
                {
                    "query": "Overture - So Much More Than Pay Per Click\\\\Overture is known for being the Leader in \"Per Per Click\" (PPC).Owned by Yahoo, Overture advertisers can reach over 80 of Internet users. If you take \\a closer look and pop the hood, you'll find a whole suite of useful tools for ...\nWhat's this about?\n\nOPTIONS:\n- World\n- Sports\n- Business\n- Science/Tech\n",
                },
            ]
        }
    },
    {
        ...
        "outputs": {
            ...
            "examples": [
                {
                    "query": "input question: To find new music when you are bored of your usual bands,\n\nOPTIONS:\n- try looking at some playlists on Spotify.\n- try listening to AM radio instead of FM.\n\noutput answer:",
                    "response": " try looking at some playlists on Spotify.\n\n" 
                },
                {
                    "query": "[Q]: Objective: To heal chapped lips when they are developing, OPTIONS:\n- leave a wet green tea bag on your lips over night.\n- leave a salt packet on your lips at night while asleep.\n[A]:",
                    "response": " leave a wet green tea bag on your lips over night.\n\n" 
                },
                {
                    "query": "Q: Here is a goal: brush\n\nHow would you accomplish this goal?\n\nOPTIONS:\n- can be gripped by fingernails \n- can be gripped by mittens \n\nA:",
                    "response": " can be gripped by mittens \n\n" 
                },
                {
                    "query": "Goal:\nStore baby pacifiers.\nOPTIONS:\n- Keep in full plastic sauce containers.\n- Keep in empty plastic sauce containers.\nAnswer:\n",
                    "response": "Keep in empty plastic sauce containers.\n\n" 
                },
                {
                    "query": "Question:\nGoal: To get better rest at night,\n\nWhich of the following methods is more reasonable for accomplishing this goal?\n\nOPTIONS:\n- don't use any electronics, especially your phone for an hour before bed.\n- download a sleep app on your phone and sleep with it on your pillow.\nAnswer:\n",
                    "response": "don't use any electronics, especially your phone for an hour before bed.\n\n" 
                },
                {
                    "query": "Goal:\nTo easily organize headphones inside your purse and avoid tangles\nOPTIONS:\n- clip the headphone coil together with a hair tie.\n- Put the headphones inside of a small pocket.\nAnswer:\n"
                },
...
def format_outputs(outputs):
    ...
    for example in outputs["examples"]:
        out += f"<section>\n"
        out += f"\t<h>{example['query']}</h>\n"
        if "response" in example:
            out += f"\t<p>{example['response']}</p>\n"
        out += "</section>\n"
    return out.strip()
